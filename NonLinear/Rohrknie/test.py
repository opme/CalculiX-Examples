...
if __name__ == '__main__':
    ...
    os.system("cgx -bg shell-modal.fbd")
    os.system("cgx -bg shell-sym-modal.fbd")
    os.system("cgx -bg solid-modal.fbd")
    os.system("cgx -bg solid-sym-modal.fbd")
    os.system("cgx -bg solid-static.fbd")
    os.system("ccx solid-static")
    os.system("monitor.py solid-static")
    os.system("cgx -bg post-solid-static.fbd")
    move(snap)
