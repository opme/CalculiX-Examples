...
if __name__ == '__main__':
    ...
    # os.system('cgx -bg vpre.fbd')
    # os.system('cgx -bg plots.fbd')
    # os.system('cgx -bg 2D.fbd')
    # os.system('cgx -bg Zug-post.fbd')
    # os.system('cgx -bg expansion.fbd')
    # os.system('cgx -bg expansion2.fbd')
    # os.system('cgx -bg expansion3.fbd')
    move(snap)
